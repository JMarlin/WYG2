...
emcc -c -o styleutils.bc styleutils.c
emcc -c -o ../fake_lib/fake_os.bc ../fake_lib/fake_os.c
emcc -o ../current_build.js ../fake_lib/fake_os.bc calculator.bc textbox.bc listnode.bc button.c list.bc context.bc window.bc desktop.bc entry.bc rect.bc -s NO_EXIT_RUNTIME=1
